...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/CaprylicAcid/jasminerice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/CaprylicAcid/CARBS/master/progs.csv"
